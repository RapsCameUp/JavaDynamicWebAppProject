			...
			<div class="offset-sm-1 col-sm-10">
				<div class="card">
					<div class="card-header">
						<p class="float-start">Teacher Details</p>
						<a type="button" class="btn btn-sm btn-primary float-end" data-bs-toggle="modal" data-bs-target="#assignteachermodal">Assign to a class</a>
					</div>
					<div class="card-body">
					<form action="teachers" method="post">
					  <div class="mb-3">
					    <label class="form-label">Name</label>
					    <input type="text" class="form-control" name="name" value="<c:out value='${teacher.name}'/>">
					  </div>
					    <div class="mb-3">
					    <label class="form-label">Surname</label>
					    <input type="text" class="form-control" name="surname" value="<c:out value='${teacher.surname}'/>">
					  </div>
					    <div class="mb-3">
					    <label class="form-label">Phone Numbers</label>
					    <input type="text" class="form-control" name="cell" value="<c:out value='${teacher.cell}'/>">
					  </div>
					  
					  <input type="hidden" name="id" value="<c:out value='${teacher.id}' />" />
					  <input type="hidden" name="action" value="doPut" />
					
					  <button type="submit" class="btn btn-sm btn-secondary">Update Details</button>
					  <a class="btn btn-sm btn-danger" href="deleteteacher?id=<c:out value='${teacher.id}' />">Remove</a>		
					</form>
					</div>
				</div>
			</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					  <div class="mb-3">
					   ...
					   <input type="hidden" class="form-control" name="action" value="doAssignTeacher">		
