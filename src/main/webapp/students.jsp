			...
			<div class="offset-sm-1 col-sm-10">
				<div class="card">
					<div class="card-header">
						<p class="float-start">Students</p>
						<a type="button" class="btn btn-sm btn-primary float-end" href="addnewstudent.jsp">Add New Student</a>
					</div>
					<div class="card-body">
						<table class="table">
							<thead>
							...
							<tbody>
								<c:forEach var="temp" items="${ ListOfStudents }">
									<tr>
										...
										<td>${temp.cell}</td>
										<td>${temp.email}</td>
										<td>${temp.studentClass}</td>
										<td>
											<a class="btn btn-sm btn-primary" href="students?action=view&id=<c:out value='${temp.id}' />">View</a>
											<a class="btn btn-sm btn-danger" href="students?action=delete&id=<c:out value='${temp.id}' />">Remove</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
