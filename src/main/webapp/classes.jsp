			...
			<div class="offset-sm-1 col-sm-10">
				<div class="card">
					<div class="card-header">
						<p class="float-start">Classes</p>
						<a type="button" class="btn btn-sm btn-primary float-end"
							data-bs-toggle="modal" data-bs-target="#addnewclassmodal">Add
							New Class</a>
					</div>
					<div class="card-body">
						<table class="table">
								...
								<c:forEach var="temp" items="${ ListOfClasses }">
									<tr>
										...
										<td><a class="btn btn-sm btn-danger"
											href="classes?action=delete&id=<c:out value='${temp.id}' />">Remove</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Enter Class Details Below</h5>
