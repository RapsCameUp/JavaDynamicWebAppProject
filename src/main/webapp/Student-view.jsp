			...
			<div class="offset-sm-1 col-sm-10">
				<div class="card">
					<div class="card-header">
						<p class="float-start">Student Details</p>
					</div>
					<div class="card-body">
					<form action="teachers" method="post">
					  <div class="mb-3">
					    ...
					    <input type="text" class="form-control" name="surname" value="<c:out value='${student.surname}'/>">
					  </div>
					      <div class="mb-3">
					    <label class="form-label">Class</label>
					    <input type="text" class="form-control" name="studentclass" value="<c:out value='${student.studentClass}'/>">
					  </div>
					      <div class="mb-3">
					    <label class="form-label">Email</label>
					    <input type="email" class="form-control" name="email" value="<c:out value='${student.email}'/>">
					  </div>
					    <div class="mb-3">
					    <label class="form-label">Phone Numbers</label>
					    <input type="text" class="form-control" name="cell" value="<c:out value='${student.cell}'/>">
					  </div>
					  ...
					  <a class="btn btn-sm btn-danger" href="deleteteacher?id=<c:out value='${student.id}' />">Remove</a>		
					</form>
					</div>
				</div>
			</div>
