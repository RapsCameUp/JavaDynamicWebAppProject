			...
			<div class="offset-sm-1 col-sm-10">
				<div class="card">
					<div class="card-header">
						<p class="float-start">Teachers</p>
						<a type="button" class="btn btn-sm btn-primary float-end" href="addnewteacher.jsp">Add New Teacher</a>
					</div>
					<div class="card-body">
						<table class="table">
							<thead>
							...
							<tbody>
								<c:forEach var="temp" items="${ ListOfTeachers }">
									<tr>
										...
										<td>${temp.cell}</td>
										<td>
											<a class="btn btn-sm btn-primary" href="teachers?action=view&id=<c:out value='${temp.id}' />">View</a>
											<a class="btn btn-sm btn-danger" href="teachers?action=delete&id=<c:out value='${temp.id}' />">Remove</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
